...
if __name__ == '__main__':
    config = {
        ...
        'key_deserializer': lambda key: int(key.decode('utf-8')), # .decode() is needed to convert bytes to str
        'value_deserializer': lambda x: loads(x.decode('utf-8'), object_hook=lambda d: Ride.from_dict(d)), # loads() is needed to convert str to dict
