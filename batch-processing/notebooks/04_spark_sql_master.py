...
# Navigate to ~/spark/spark/spark-3.4.3-bin-hadoop3/sbin, run ./start-master.sh to obtain master-url
# Browse for localhost:8080 and paste master-url below
MASTER_URL = "spark://Trydex.:7077"
